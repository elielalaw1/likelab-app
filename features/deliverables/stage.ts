...
export type DeliverableStage = 'upload' | 'under_review' | 'revision' | 'submit_link' | 'live'
...
> = {
  ...
  under_review: { label: 'In review',     color: '#7A3FF2', bg: 'rgba(124,63,242,0.12)', ring: ['#A78BFA', '#7A3FF2'], glow: 'rgba(124,63,242,0.18)', icon: 'clock-outline',       instruction: 'The brand is checking your video. Nothing to do right now.',     actionable: false },
